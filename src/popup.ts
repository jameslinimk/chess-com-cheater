...
export const loadPopup = () => {
	...
	const localGameMode = localStorage.getItem("cc-popup-gamemode")
	if (localGameMode) currentGameMode.innerText = localGameMode

	const standardButton = document.getElementById("cc-standard-mode-button") as HTMLButtonElement
	const fenModeButton = document.getElementById("cc-fen-mode-button") as HTMLButtonElement

	const saveGameMode = () => localStorage.setItem("cc-popup-gamemode", currentGameMode.innerText)
	standardButton.addEventListener("click", () => {
		currentGameMode.innerText = "Standard"
		saveGameMode()
	})
	fenModeButton.addEventListener("click", () => {
		currentGameMode.innerText = "FEN"
		saveGameMode()
	})
